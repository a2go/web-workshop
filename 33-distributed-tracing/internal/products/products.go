...
func List(ctx context.Context, db *sqlx.DB) ([]Product, error) {
	ctx, span := trace.StartSpan(ctx, "products.List")
	defer span.End()
...
func Create(ctx context.Context, db *sqlx.DB, user auth.Claims, np NewProduct, now time.Time) (*Product, error) {
	ctx, span := trace.StartSpan(ctx, "products.Create")
	defer span.End()
...
func Get(ctx context.Context, db *sqlx.DB, id string) (*Product, error) {
	ctx, span := trace.StartSpan(ctx, "products.Get")
	defer span.End()
...
func Update(ctx context.Context, db *sqlx.DB, user auth.Claims, id string, update UpdateProduct, now time.Time) error {
	ctx, span := trace.StartSpan(ctx, "products.Update")
	defer span.End()
...
func Delete(ctx context.Context, db *sqlx.DB, id string) error {
	ctx, span := trace.StartSpan(ctx, "products.Delete")
	defer span.End()
